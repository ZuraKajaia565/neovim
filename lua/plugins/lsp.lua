...
return {
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        clangd = {
          -- Clangd specific settings (you can modify as needed)
          cmd = { 'clangd', '--background-index' },
          filetypes = { 'cpp' },
          settings = {
            clangd = {
              -- You can add additional clangd specific settings here
            },
          },
        },
        pyright = {
        ...
        jdtls = {
          cmd = { 'jdtls' }, -- Ensure the `jdtls` binary is installed and in PATH
          ...
          init_options = {
            bundles = {}, -- You can configure debug bundles here
          },
        },
      }
